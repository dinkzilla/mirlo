...
import remoteFollow from "../../../src/routers/v1/artists/{profileId}/remoteFollow";
...
describe("artists/{profileId}/remoteFollow", () => {
  ...
  const callHandler = (profileId: number, query: object) => {
    mockRes.locals.profileId = profileId;
    return getHandler()(
