...
import labelsEndpoint from "../../../../src/routers/v1/manage/artists/{profileId}/labels/index";
import { clearTables, createProfile, createUser } from "../../../utils";
import { requestApp } from "../../utils";

import prisma from "@mirlo/prisma";

describe("manage/artists/{profileId}/labels", () => {
  beforeEach(async () => {
    try {
      await clearTables();
    } catch (e) {
  ...
  describe("Unit tests (direct function calls)", () => {
    ...
    it("should fail if labelUserId is missing", async () => {
      ...
      const mockRes = { locals: { profileId: artist.id } } as any;
      const mockNext = sinon.stub();
    ...
    it("should fail if artist doesn't exist", async () => {
      ...
      const mockRes = { locals: { profileId: 99999 } } as any;
      const mockNext = sinon.stub();
